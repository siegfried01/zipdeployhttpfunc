...
resource privateStorageFileDnsZoneName_privateStorageFileDnsZoneName_link 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2020-06-01' = {
...
resource privateStorageBlobDnsZoneName_privateStorageBlobDnsZoneName_link 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2020-06-01' = {
...
resource privateStorageTableDnsZoneName_privateStorageTableDnsZoneName_link 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2020-06-01' = {
...
resource privateStorageQueueDnsZoneName_privateStorageQueueDnsZoneName_link 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2020-06-01' = {
...
resource privateEndpointStorageFileName_filePrivateDnsZoneGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2022-05-01' = {
...
resource privateEndpointStorageBlobName_blobPrivateDnsZoneGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2022-05-01' = {
...
resource privateEndpointStorageTableName_tablePrivateDnsZoneGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2022-05-01' = {
...
resource privateEndpointStorageQueueName_queuePrivateDnsZoneGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2022-05-01' = {
...
resource functionStorageAccountName_default_functionContentShare 'Microsoft.Storage/storageAccounts/fileServices/shares@2022-05-01' = {
...
resource functionApp 'Microsoft.Web/sites@2022-03-01' = {
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        }
        {
          ...
          value: 'DefaultEndpointsProtocol=https;AccountName=${functionStorageAccountName};AccountKey=${listkeys(functionStorageAccount.id,'2022-05-01').keys[0].value}'
        }
        {
  ...
  dependsOn: [
    resourceId(
      ...
      split('${functionStorageAccountName}/default/${functionContentShareName}', '/')[0],
      split('${functionStorageAccountName}/default/${functionContentShareName}', '/')[1],
      split('${functionStorageAccountName}/default/${functionContentShareName}', '/')[2]
    )

    privateEndpointStorageBlobName_blobPrivateDnsZoneGroup
    privateEndpointStorageFileName_filePrivateDnsZoneGroup
    privateEndpointStorageQueueName_queuePrivateDnsZoneGroup
    privateEndpointStorageTableName_tablePrivateDnsZoneGroup
    privateStorageBlobDnsZoneName_privateStorageBlobDnsZoneName_link
    privateStorageFileDnsZoneName_privateStorageFileDnsZoneName_link
    privateStorageQueueDnsZoneName_privateStorageQueueDnsZoneName_link
    privateStorageTableDnsZoneName_privateStorageTableDnsZoneName_link
  ]
}
...
resource privateFunctionAppDnsZoneName_privateFunctionAppDnsZoneName_link 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2020-06-01' = {
...
resource privateEndpointFunctionApp 'Microsoft.Network/privateEndpoints@2022-05-01' = {
...
resource privateEndpointFunctionAppName_funcPrivateDnsZoneGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2022-05-01' = {
  parent: privateEndpointFunctionApp
